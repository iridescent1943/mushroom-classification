...
# Create a deep neural network using the Keras API with one input layer, two hidden layers, and one output layer
initializer = RandomNormal(mean=0.0, stddev=1.0, seed=42)
model = Sequential() 
model.add(Dense(5, input_shape=(13,), activation = 'sigmoid', kernel_initializer=initializer))
